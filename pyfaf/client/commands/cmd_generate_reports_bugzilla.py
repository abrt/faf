...
class Generate_Reports_Bugzilla(kobo.client.ClientCommand):
    """Generates uReports from Bugzilla bugs"""
    enabled = True
    ...
    def run(self, *args, **kwargs):
        ...
        kwargs = {
            "owner_name": username,
            "label": "Generate reports from Bugzilla bugs",
            "method": "GenerateReportsBugzilla",
            "args": {},
            "weight": 0,
            "arch_name": "noarch",
