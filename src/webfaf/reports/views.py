...
def load_packages(db, report_id, package_type):
    ...
    unknown_packages = (db.session.query(ReportUnknownPackage.id,
                              ...
                              ReportUnknownPackage.version.label("iversion"), ReportUnknownPackage.running_version.label("rversion"),
                              ReportUnknownPackage.release.label("irelease"), ReportUnknownPackage.running_release.label("rrelease"),
                              ReportUnknownPackage.epoch.label("iepoch"), ReportUnknownPackage.running_epoch.label("repoch"),
